...
public class BiRecursivo{
  ...
  public static String buscadorR(String scrabble [], String palabra, int linf, int lsup){
    ...
    if(linf!=lsup){
      ...
      if(palabra.compareToIgnoreCase(scrabble[linf])==0){
        return "La palabra existe en el espacio "+linf;
      }
      else{
        return "La palabra no existe en el arreglo.";
      }
    }
  }
}

...
public class Binario1{
  ...
  public static void main(String[] args){
    ...
    System.out.println(buscador(scrabble, palabra));
  }

  public static String buscador(String scrabble [], String palabra){
    boolean est=false;
    int linf=0;
    int lsup=scrabble.length-1;
    int pmedio=0;
    String texto="La palabra no existe en el arreglo.";
    ...
    do{
      ...
      if(linf!=lsup){
        ...
        if(palabra.compareToIgnoreCase(scrabble[pmedio])==0){
          texto="La palabra existe en el espacio "+pmedio;
          est=true;
        }
        ...
        if(palabra.compareToIgnoreCase(scrabble[linf])==0){
          texto="La palabra existe en el espacio "+linf;
        }
        est=true;
      }
    }while(est==false);
